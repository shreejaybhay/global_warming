...
export default function HomeEnergyOptimization() {
  const steps = [
    {
      ...
      stats: {
        ...
        lifespan: "25,000 hours average",
        impact: "Reduce CO2 by 300kg/year",
      },
      tips: [
        "Look for BIS certified LED bulbs",
        "Replace CFL and incandescent bulbs first",
        "Consider smart LED bulbs for additional control",
      ],
      warning: "Check voltage compatibility (230V for India)",
    },
    {
      title: "Smart Thermostat Installation",
      description:
        "Optimize AC and cooling with intelligent temperature control",
      icon: Thermometer,
      difficulty: "Moderate",
      timeToImplement: "2-3 hours",
      initialCost: "₹8,000-15,000",
      stats: {
        savings: "Save 20-25% on AC bills",
        cooling: "Optimize cooling efficiency",
        impact: "Reduce CO2 by 0.8 tons/year",
      },
      tips: [
        "Set temperature to 24-26°C for optimal efficiency",
        "Use scheduling features during peak hours",
        "Regular AC maintenance",
      ],
      warning: "Ensure compatibility with split/window AC units",
    },
    {
      title: "Improve Home Insulation",
      description:
        "Enhance your home's thermal efficiency with proper insulation",
      icon: Home,
      difficulty: "Complex",
      timeToImplement: "3-4 days",
      initialCost: "₹20,000-80,000",
      stats: {
        savings: "Save 20% on cooling costs",
        efficiency: "Reduce indoor temperature by 4-5°C",
        impact: "Reduce CO2 by 1.2 tons/year",
      },
      tips: [
        "Start with roof/terrace insulation",
        "Install window films or double glazing",
        "Use weather stripping for doors and windows",
      ],
      warning: "Consider monsoon waterproofing requirements",
    },
  ];
      ...
      <section className="relative py-32 border-b border-border/40 overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <div className="p-3 rounded-xl bg-emerald-500/10 ring-1 ring-emerald-500/20 shadow-lg shadow-emerald-500/5">
                <Home className="h-6 w-6 text-emerald-500" />
              </div>
              <Badge
                variant="outline"
                className="text-emerald-500 border-emerald-500/20 uppercase tracking-wide text-xs font-semibold"
              >
                Energy Efficiency
              </Badge>
            </motion.div>
            <motion.h1
              variants={fadeIn}
              className="text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 via-primary to-blue-500 leading-[1.2] pb-1"
            >
              Home Energy Optimization Guide
            </motion.h1>
            <motion.p
              variants={fadeIn}
              className="text-xl text-muted-foreground/90 mb-8 leading-relaxed"
            >
              Transform your home into an energy-efficient sanctuary while
              reducing your carbon footprint and saving on utility bills.
            </motion.p>
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-muted-foreground/90 mb-8 text-lg leading-relaxed">
              Get personalized recommendations and connect with certified
              professionals to start your home energy optimization journey.
            </p>
